...
class FamilyPageItem extends StatefulWidget {
  String Text1 = "";
  String Text2 = "";
  String Sound = "";
  String image;
  FamilyPageItem({Key? key, required this.Text1,
    required this.Text2, required this.image, required this.Sound}) : super(key: key);

  @override
  State<FamilyPageItem> createState() => _NumbersPageItemState();
}

class _NumbersPageItemState extends State<FamilyPageItem> {
